defmodule CourseMembershipTest do
  ...
  test "teacher invite student succeeds" do
    result = Schoolhub.CourseAdminServer.invite_student(@test_user_teacher,
      @test_user_student, @test_course)
    assert result == :ok
  end

  test "admin invite student succeeds" do
    result = Schoolhub.CourseAdminServer.invite_student(@admin,
      @test_user_student, @test_course)
    assert result == :ok
  end
  ...
  test "student invite user fails" do
    result = Schoolhub.CourseAdminServer.invite_student(@test_user_student,
      @test_user_student, @test_course)
  ...
  test "teacher remove student succeeds" do
    :ok = Schoolhub.CourseAdminServer.invite_student(@test_user_teacher,
      @test_user_student, @test_course)
    result = Schoolhub.CourseAdminServer.remove_student(@test_user_teacher,
      @test_user_student, @test_course)
    assert result == :ok
  end
  ...
  test "admin remove student succeeds" do
    :ok = Schoolhub.CourseAdminServer.invite_student(@test_user_teacher,
      @test_user_student, @test_course)
    result = Schoolhub.CourseAdminServer.remove_student(@admin,
      @test_user_student, @test_course)
    assert result == :ok
  end
  ...
  test "student remove student fails" do
    result = Schoolhub.CourseAdminServer.remove_student(@test_user_student,
      @test_user_student, @test_course)
    assert result == {:error, :no_permission}
  end
  ...
  test "teacher set affiliation succeeds" do
    :ok = Schoolhub.CourseAdminServer.invite_student(@test_user_teacher,
      @test_user_student, @test_course)
    result = Schoolhub.CourseAdminServer.set_affiliation(@test_user_teacher,
  ...
  test "admin set affiliation succeeds" do
    :ok = Schoolhub.CourseAdminServer.invite_student(@test_user_teacher,
      @test_user_student, @test_course)
    result = Schoolhub.CourseAdminServer.set_affiliation(@admin,
      @test_user_student, @test_course, 'assistant')
    assert result == :ok
  end
  ...
  test "student change affiliation fails" do
    :ok = Schoolhub.CourseAdminServer.invite_student(@test_user_teacher,
      @test_user_student, @test_course)
    result = Schoolhub.CourseAdminServer.set_affiliation(@test_user_student,
      @test_user_student, @test_course, 'assistant')
    assert result == {:error, :no_permission}
  end
