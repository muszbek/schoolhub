...
config :schoolhub_router, SchoolhubRouter.Repo,
  username: System.get_env("POSTGRES_USER", "schoolhub_router"),
  password: System.get_env("POSTGRES_PASSWORD", "schoolhub_router"),
  database: System.get_env("POSTGRES_DB", "schoolhub_router"),
...
#
#     config :schoolhub_router, SchoolhubRouterWeb.Endpoint, server: true
#
