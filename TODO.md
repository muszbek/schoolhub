...
k3d image import phx_server:v0.4 router_phx_server:v0.4 mongooseim/mongooseim:3.7.1 postgres:13.3 haproxy:2.4 boky/postfix:v3.3.0 busybox:1.33

make it possible to reset database from api

why two admin pw requests?

private docker image repo for kubernetes cluster
